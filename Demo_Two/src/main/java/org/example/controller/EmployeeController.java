...
import org.example.service.EmployeeJmsListener;
...
public class EmployeeController {
    ...
    @Autowired
    private EmployeeJmsListener employeeJmsListener;
   ...
   /* @PostMapping("/save-employee")
    ...
    @PostMapping("/save-employee")
    public String saveEmployee(@RequestParam String name,RedirectAttributes redirectAttributesModel, Model model, @RequestParam Integer age, @RequestParam String sex,
        ...
        employeeServiceimpl.saveEmployee(employee);
        //model.addAttribute("messages", employeeJmsListener.getMessages());
        redirectAttributesModel.addFlashAttribute("messages", employeeJmsListener.getMessages());
        return "redirect:/view-employees";
    }
    ...
    public String viewEmployees(Model model) {
        //EmployeeJmsListener employeeJmsListener = null;
        //model.addAttribute("messages", employeeJmsListener.getMessages());
